...
STORES = ("tasks", "notes", "bookmarks", "habits", "finance", "quicklinks", "settings", "feeds", "health", "stocks", "mockexams", "quicknotes", "anniv", "reminders", "media", "timeline", "trackers", "trackerlogs", "timeentries", "subscriptions")
