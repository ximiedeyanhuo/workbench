...
(function () {
  ...
  function statCardHtml(cats, mtx, txs) {
    ...
    else if (finStatView === "budget") body = window.WB.finStats.buildBudget(cats, mtx, finCatBudgetCur);
    else if (finStatView === "week") body = window.WB.finStats.buildWeek(txs, finYear);
    else if (finStatView === "month") body = window.WB.finStats.buildMonth(txs, finYear);
    else body = window.WB.finStats.buildYear(txs);
